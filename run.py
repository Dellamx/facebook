...
for t in range(10000):
	...
	b=random.choice(['NRD90M','OPM1','TP1A','RP1A','PPR1','PKQ1','QP1A','SP1A','RKQ1','ZN4L88'])
	c=random.randrange(111111,210000)
	d=random.randrange(11,19)
	e=random.randrange(73,100)
	f=random.randrange(4200,4900)
	g=random.randrange(40,150)
	random1=random.choice(['CPH2109','SM-M236B','SM-A037G','SM-J701MT','SM-A115U','SM-G610M','SM-J530F','SM-A307FN','SM-A405FN','vivo1812'])
	random2=random.choice(['SM-J415N','SM-R765T','SM-A730F','SM-A605G','SM-J610F','SM-N9750','SM-G935A','RMX2052'])
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'Sukses!' in str(response6):
							...
							print("\n ╰─  Login Berhasil | python Facebook.py");exit()
			except Exception as e:
				print(" ╰─  Cookies Mokad ")
